    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var imagePredictions =
                context.Data.CreateEnumerable<ImagePrediction>(predictions, reuseRowObject: false,
            ...
            {
                ImagePath = Path.Combine(Environment.CurrentDirectory, "images", "cup.png")
            }));


            Console.WriteLine($"Image {Path.GetFileName(singlePrediction.ImagePath)} was predited as a  {singlePrediction.PredictedLabelValue} with a score of {singlePrediction.Score.Max()}");
